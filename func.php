<?php 
    ...
    function insertAlternatif($data){
        ...
        $query = "INSERT INTO alternatif VALUE(NULL,'$nmAlternatif', '$id_jenis')";
    ...
    function insertvendor($data){
        global $conn;
        $nmvendor = htmlspecialchars($data['vendor']);
        $query = "INSERT INTO jenis VALUE(NULL,'$nmvendor')";
        mysqli_query($conn,$query);
        return mysqli_affected_rows($conn);
    }
    ...
    function updatevendor($data){
        ...
        $idvendor = $data['id'];
        $nmvendor = htmlspecialchars($data['vendor']);
        $query = "UPDATE jenis SET nm_jenis='$nmvendor' WHERE id_jenis=$idvendor";
        mysqli_query($conn,$query);
        return mysqli_affected_rows($conn);
    }
    ...
    function ranking(){
        ...
        foreach($alternatif as $alternatif){
            ...
            foreach($dataNilaiAlternatif as $dataNilaiAlternatif){
                ...
                $nilai[] = (($dataNilaiAlternatif['nilai'] - 20) / 80) * $normalisasi;
